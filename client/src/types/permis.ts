export enum TypePermisSpecial {
  ...
  GRANDE_CHASSE_RESIDENT = 'GRANDE_CHASSE_RESIDENT',
  GIBIER_EAU_RESIDENT = 'GIBIER_EAU_RESIDENT',
  // Coutumier
  PETITE_CHASSE_COUTUMIER = 'PETITE_CHASSE_COUTUMIER',
  // Touriste - 1 semaine
  TOURISTE_1SEM_PETITE = 'TOURISTE_1SEM_PETITE',
  TOURISTE_1SEM_GRANDE = 'TOURISTE_1SEM_GRANDE',
  TOURISTE_1SEM_GIBIER_EAU = 'TOURISTE_1SEM_GIBIER_EAU',
  // Touriste - 2 semaines
  TOURISTE_2SEM_PETITE = 'TOURISTE_2SEM_PETITE',
  TOURISTE_2SEM_GRANDE = 'TOURISTE_2SEM_GRANDE',
  TOURISTE_2SEM_GIBIER_EAU = 'TOURISTE_2SEM_GIBIER_EAU',
  // Touriste - 1 mois
  TOURISTE_1MOIS_PETITE = 'TOURISTE_1MOIS_PETITE',
  TOURISTE_1MOIS_GRANDE = 'TOURISTE_1MOIS_GRANDE',
  TOURISTE_1MOIS_GIBIER_EAU = 'TOURISTE_1MOIS_GIBIER_EAU',
  ...
  CERTIFICAT_EXPORT = 'CERTIFICAT_EXPORT',
  CERTIFICAT_DETENTION = 'CERTIFICAT_DETENTION',
