...
import domainesRoutes from './domaines.routes.js';
...
import infractionsRoutes from './infractions.routes.js';
...
import protectedZonesRoutes from './protectedZones.routes.js';
import reboisementRoutes from './reboisement.routes.js';
...
import userDomainsRoutes from './userDomains.routes.js';
...
export default function registerRoutes(app: Express): void {
  ...
  // Routes pour la synchronisation offline (batch)
  ...
  // Routes pour les domaines utilisateurs (multi-domain auth)
  app.use('/api/user-domains', userDomainsRoutes);

  app.use('/api/domaines', domainesRoutes);

  // Routes pour les affectations (moteur de droits des agents)
  app.use('/api/affectations', affectationsRoutes);

  // Routes pour les agents (registre)
  ...
  // Routes d'administration (gestion profils chasseurs)
  ...
  // Routes pour les zones protégées
  app.use('/api/protected-zones', protectedZonesRoutes);

  // Routes pour les zones (ZICs, amodiées, parc_visite, regulation)
  app.use('/api/zones', zonesRoutes);

  // Routes pour les infractions, contrevenants, PV et fichiers associés
